  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-gradient-to-br from-befoundPurple via-befoundPurple/95 to-black overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1920&h=1080&fit=crop')] opacity-10 bg-cover bg-center"></div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl lg:text-2xl mb-10 text-white/90 max-w-3xl mx-auto leading-relaxed">
              Drive 180% more online orders with commission-free ordering systems, smart reservations, and digital marketing built for the US market
            </p>
      ...
      <section className="py-0 bg-white">
        <ExpandCards 
          ...
          defaultExpanded={3}
          title="Restaurant Technology Solutions That Drive Results"
          subtitle="Comprehensive digital solutions built for restaurants"
        />
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8 md:mb-12">
              ...
              <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto px-4">
                Everything you need to take orders, manage reservations, and grow your restaurant business
              </p>
            </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-6 md:mb-8">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 text-befoundPurple px-4">Restaurant Success Stories</h2>
      ...
      {blogPosts.length > 0 && (
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-8 md:mb-12">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 md:mb-4 px-4">Restaurant Insights & Guides</h2>
