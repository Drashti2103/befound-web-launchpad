  ...
  return (
    <main className="relative w-[95%] sm:w-[90%] max-w-7xl mx-auto min-h-[calc(100vh-4rem)] flex flex-col md:flex-row items-center gap-8 sm:gap-12 py-16 sm:py-24 px-4 sm:px-6">
      ...
      <img
        ...
        alt="Abstract technology and software development background pattern"
      ...
      <img
        ...
        alt="Circuit board pattern representing technology innovation and digital transformation"
